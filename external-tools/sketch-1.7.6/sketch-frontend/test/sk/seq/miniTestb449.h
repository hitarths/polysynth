#ifndef MINITESTB449_H
#define MINITESTB449_H
...
extern void foreach_body12(MultiType* lst, MultiType*& listTypeMT12, MultiType* poly3);
...
extern void body12(MultiType* i, MultiType*& listTypeMT1, MultiType* poly);
