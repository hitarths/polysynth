...
class Polynomial:
    ...
    #         print("here")
    #         # it is monomial
    #         return (len(self.monomial_dict.keys()) == 1) and (mono in self.monomial_dict) and (self.monomial_dict[mono] == 1)
    #     else:
    #         is_eq = True
    #         for i in list(self.monomial_dict.keys()) + list(other.monomial_dict.keys()):
    #             l_coeff = self.monomial_dict[i] if i in self.monomial_dict else False
    #             r_coeff = other.monomial_dict[i] if i in other.monomial_dict else False
    #             if not (l_coeff and r_coeff):
    #                 return False
    #             if l_coeff != r_coeff:
    #                 return False
    #         return True
